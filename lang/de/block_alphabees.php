...
$string['allow_remote_placement_desc'] = 'Wenn aktiviert, kann das Alphabees-Portal autonom neue Alphabees-Bloecke in Kurse auf dieser Site einfuegen (z.B. Tutor-Rollout ueber eine ganze Fachgruppe). Das Aktualisieren oder Entfernen bestehender Platzierungen funktioniert auch ohne diese Einstellung — nur die autonome Erstellung ist gegated. Standardmaessig deaktiviert.';
$string['allow_remote_placement_short'] = 'Erlaubt dem Portal, autonom neue Tutor-Blöcke auf dieser Site zu platzieren. Standard: aus.';
...
$string['apikey_desc'] = 'Geben Sie den API Key ein, um auf den Alphabees-Dienst zuzugreifen. Erhältlich auf portal.alphalearn.ai. Nach dem Speichern registriert sich die Site automatisch beim Alphabees-Backend — der Verbindungsstatus unten wechselt innerhalb von 1–2 Minuten (beim nächsten Moodle-Cron-Lauf) auf "Verbunden".';
...
$string['connect_apikey_missing'] = 'Bitte zuerst einen API-Key eintragen.';
...
$string['connect_now_help'] = 'Überspringt den nächsten Cron-Lauf und versucht sofort eine Registrierung beim Alphabees-Backend. Praktisch zum Testen oder nach Behebung eines Verbindungsproblems.';
$string['connect_pending'] = 'Alphabees-Backend ist gerade nicht erreichbar. Die Site versucht es im Hintergrund automatisch erneut.';
$string['connect_success'] = 'Mit dem Alphabees-Backend verbunden.';
$string['connectionstatus'] = 'Verbindungsstatus';
$string['connectionstatus_apikey_help'] = 'Ihr Alphabees-API-Key. Erhältlich auf portal.alphalearn.ai. Beim Speichern startet die Site-Registrierung im Hintergrund.';
$string['connectionstatus_intro'] = 'Sobald Sie einen API-Key speichern, registriert sich diese Moodle-Site automatisch beim Alphabees-Backend. Der Status unten wechselt innerhalb von 1–2 Minuten (beim nächsten Moodle-Cron-Lauf) auf <b>Verbunden</b>. Bis dahin steht hier <b>Nicht verbunden</b> — das ist kein Fehler.';
...
$string['ws_enable_short'] = 'Gewährt dem Alphabees-Backend site-weiten Lese-/Schreibzugriff auf Kurse, Nutzer und Noten über einen dedizierten Service-User. Voller Umfang siehe Status-Bereich unten. Standard: aus.';
